...
pub struct ClassicalPermutation(DefaultPermutation);

impl ClassicalPermutation {
    /// Get a identity permutation
    pub fn id() -> Self {
        ClassicalPermutation(DefaultPermutation::id())
    }
    ...
    pub fn from_slice(images: &[usize]) -> Self {
        ...
        ClassicalPermutation(DefaultPermutation::from_vec(
...
impl From<DefaultPermutation> for ClassicalPermutation {
...
impl From<ClassicalPermutation> for DefaultPermutation {
...
mod tests {
    ...
    #[test]
    fn from_permutation() {
        let basic = DefaultPermutation::from_vec(vec![0, 2, 1]);
    ...
    fn to_permutation() {
        ...
        let basic: DefaultPermutation = classic.into();
